...
RSpec.describe Post, type: :model do
    ...
    subject { Post.new(author: author, title: 'This World is fake', text: 'This is a post') }
    ...
    describe '#recent_comments' do 
      ...
      comment1 = Comment.create(user: author, post: subject, text: 'comment', created_at: 12.days.ago)
      comment2 = Comment.create(user: author, post: subject, text: 'comment', created_at: 10.days.ago)
      comment3 = Comment.create(user: author, post: subject, text: 'comment', created_at: 9.days.ago)
      comment4 = Comment.create(user: author, post: subject, text: 'comment', created_at: 7.days.ago)
      comment5 = Comment.create(user: author, post: subject, text: 'comment', created_at: 5.days.ago)
      comment6 = Comment.create(user: author, post: subject, text: 'comment', created_at: 2.days.ago)
