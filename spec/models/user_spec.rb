...
RSpec.describe User, type: :model do
    ...
    it 'should return 3 recent posts' do
      post1 = Post.create(author: subject, title: 'The best', text: 'Just a post', created_at: 5.days.ago)
      post2 = Post.create(author: subject, title: 'The best', text: 'Just a post', created_at: 4.days.ago)
